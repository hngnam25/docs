...
If you prefer to run the Gateway system locally, follow the setup instructions in Setting Up your Docker Image. After completing the setup, you can connect to your locally running API server:
...
1. **Start** the API and Inference servers (see separate document for Docker instructions).
